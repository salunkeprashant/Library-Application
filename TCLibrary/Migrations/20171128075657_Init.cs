        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AdminId = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    AdminId1 = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookTransactions", x => x.AdminId);
                    table.ForeignKey(
                        name: "FK_BookTransactions_Admins_AdminId1",
                        column: x => x.AdminId1,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ItemTransactions_Inventories_ItemId",
                        column: x => x.ItemId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookTransactions_AdminId1",
